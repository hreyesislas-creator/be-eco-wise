  ...
  return (
    ...
    >
        ...
        >
          <div className="absolute inset-0 opacity-[0.42]">
            <div
              ...
              style={{
                filter:
                  "blur(1px) brightness(1.18) contrast(1.12) saturate(1.05)",
                WebkitFilter:
                  "blur(1px) brightness(1.18) contrast(1.12) saturate(1.05)",
              }}
            >
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-20 sm:px-6 sm:pb-16 sm:pt-24 lg:pt-28">
        <div className="grid items-start gap-14 lg:grid-cols-[1fr_minmax(300px,400px)] lg:gap-12 xl:grid-cols-[1.15fr_minmax(340px,420px)] xl:gap-16">
          <div className="relative max-w-2xl xl:max-w-none">
            ...
            <p className="relative text-[11px] font-medium uppercase tracking-[0.35em] text-[var(--home-accent-light)]/90">
              Southern California · Installation only
            </p>
            ...
            <h1 className="relative mt-6 text-[2.35rem] font-extralight leading-[1.08] tracking-[-0.03em] text-white sm:text-5xl lg:text-6xl xl:text-[3.5rem]">
              Surfacing that
            ...
            <p className="relative mt-8 max-w-md text-lg font-light leading-relaxed text-white/55 sm:text-xl sm:leading-relaxed">
              Rubber mulch installed to depth and detail — for playgrounds,
              schools, HOAs, parks, and estates. No pallets left curbside.
            </p>
